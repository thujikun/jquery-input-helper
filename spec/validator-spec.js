(function() {
    describe('test for validation with HTML data attribute settings', function() {
        ...
        it('all-kana format check for inputted not all-kana field', function(done) {
            var $input = $form.find('input[name=all-kana]');
        ...
        it('all-kana format check for inputted only all-kana field', function(done) {
            var $input = $form.find('input[name=all-kana2]');
        ...
        it('all-char format check for inputted not all-char field', function(done) {
            var $input = $form.find('input[name=all-char]');
        ...
        it('all-char format check for inputted only all-char field', function(done) {
            var $input = $form.find('input[name=all-char2]');
